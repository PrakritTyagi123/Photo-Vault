...
public partial class PluginsViewModel : ObservableObject
{
    ...
    public PluginsViewModel(PluginService plugins) { _plugins = plugins; _pluginPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "PhotoVault", "plugins"); }
